...
int number {21};
p_score = &number;
 //scores = &number; // The array name is a pointer, but a special pointer that kind of identifiesthe entire array. You'll get the error : incompatible types in assignmentof 'int*' to 'int[10]'
cout << "p_score : " << p_score << endl;// Pointer
